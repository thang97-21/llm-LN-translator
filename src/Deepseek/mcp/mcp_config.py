"""Runtime configuration for the LLM Translator MCP server."""
...
from src.Deepseek.common.config import (
    INPUT_DIR,
    OUTPUT_DIR,
    PIPELINE_ROOT,
    WORK_DIR,
...
def default_mcp_config() -> MCPConfig:
    """Build default runtime config from src.Deepseek.common.config constants + environment."""
