...
def cost_breakdown_usd(
    ...
    **_ignored: Any,
    ...
    cache_creation_tokens is accepted for signature compatibility only —
    DeepSeek's automatic caching bills cache writes at $0.00 (confirmed live:
    the /anthropic endpoint never populates cache_creation_input_tokens for
    DeepSeek's own automatic caching, see dev/test_cross_model_cache.py).
    """
