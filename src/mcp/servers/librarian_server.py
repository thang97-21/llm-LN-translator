...
from src.librarian.content_splitter import ContentSplitter
from src.librarian.image_extractor import ImageInfo, catalog_images as catalog_images_from_epub
from src.librarian.metadata_parser import MetadataParser
from src.librarian.publisher_profiles.manager import get_profile_manager
from src.librarian.toc_parser import TOCParser
from src.librarian.xhtml_to_markdown import XHTMLToMarkdownConverter

from src.mcp.mcp_config import MCPConfig
from src.mcp.runtime import MCPRuntimeError, ensure_allowed_path, run_module
from src.mcp.runtime import load_manifest
...
def register_librarian_tools(mcp: object, cfg: MCPConfig) -> None:
    ...
    def extract_epub(
        ...
        execution = run_module("src.librarian.agent", args, cfg)
