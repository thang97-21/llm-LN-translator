"""Bible Writer MCP tools — 1 tool, direct binding to src.bible.agent.run_write_bible.
...
from src.bible.agent import BibleError, run_write_bible
from src.mcp.mcp_config import MCPConfig
from src.mcp.runtime import MCPRuntimeError, resolve_volume_dir
